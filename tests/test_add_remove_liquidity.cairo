...
fn deploy_contracts() -> (ContractAddress, ContractAddress) {
    ...
    let router_class = declare('Router');
...
fn test_add_liquidity_expired_deadline() {
    ...
    let router_safe_dispatcher = IRouterSafeDispatcher { contract_address: router_address };
...
fn test_add_remove_liquidity_created_pair(){
    ...
    let router_dispatcher = IRouterDispatcher { contract_address: router_address };
    ...
    let pair_dispatcher = IPairDispatcher { contract_address: pair_address };
