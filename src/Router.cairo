...
trait IRouter<TContractState> {
    ...
    fn get_amount_in(self: @TContractState, amountOut: u256, reserveIn: u256, reserveOut: u256) -> u256;
    fn get_amounts_out(self: @TContractState, amountIn: u256, path: Array::<ContractAddress>) -> Array::<u256>;
    fn get_amounts_in(self: @TContractState, amountOut: u256, path: Array::<ContractAddress>) -> Array::<u256>;
    // external functions
...
mod Router {
    ...
    #[external(v0)]
    impl Router of super::IRouter<ContractState> {
        //
        // Getters
        //
        ...
        fn get_amount_in(self: @ContractState, amountOut: u256, reserveIn: u256, reserveOut: u256) -> u256 {
    ...
    fn _get_amounts_out(factory: ContractAddress, amountIn: u256, path: Span::<ContractAddress>) -> Array::<u256> {
        ...
        loop {
            ...
            let (reserveIn, reserveOut) = _get_reserves(factory, *path[current_index], *path[current_index + 1]);
    ...
    fn _get_amounts_in(factory: ContractAddress, amountOut: u256, path: Span::<ContractAddress>) -> Array::<u256> {
        assert(path.len() >= 2, 'invalid path');
        let mut amounts = ArrayTrait::<u256>::new();
